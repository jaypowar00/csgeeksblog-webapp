    ...
    return (
        <>
            ...
            <div className={`main-container ${sidebarMinimize ? 'main-container-minimized' : ''}`}>
                <section className={`posts-sections ${sidebarMinimize ? 'sidebar-minimized-posts-sections' : ''} flex items-center`}>
...
export default PageNotFoundCatchAll;